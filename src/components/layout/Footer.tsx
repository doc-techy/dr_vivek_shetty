...
export function Footer() {
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/share/1DJmt7wnN6/?mibextid=wwXIfr',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/dr.vivek_shetty?igsh=NDczdDA4N2Fubnow&utm_source=qr',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@dr.vivekshetty?si=nN5Lxir6prS6QRp0',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
